...
namespace AngularTechnicalTrainingApi.Data.Migrations
{
    ...
    [Migration("20220604145014_addedAssetConfiguration")]
    partial class addedAssetConfiguration
    {
            ...
            modelBuilder.Entity("AngularTechnicalTrainingApi.Domain.Models.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TagID = 1,
                            AssetTypeID = 1,
                            DateAdded = new DateTime(2022, 6, 4, 9, 50, 14, 361, DateTimeKind.Local).AddTicks(3554),
                        ...
                        new
                        {
                            TagID = 2,
                            AssetTypeID = 2,
                            DateAdded = new DateTime(2022, 6, 4, 9, 50, 14, 361, DateTimeKind.Local).AddTicks(3590),
                        ...
                        new
                        {
                            TagID = 3,
                            AssetTypeID = 1,
                            DateAdded = new DateTime(2022, 6, 4, 9, 50, 14, 361, DateTimeKind.Local).AddTicks(3594),
                        ...
                        new
                        {
                            TagID = 4,
                            AssetTypeID = 2,
                            DateAdded = new DateTime(2022, 6, 4, 9, 50, 14, 361, DateTimeKind.Local).AddTicks(3596),
